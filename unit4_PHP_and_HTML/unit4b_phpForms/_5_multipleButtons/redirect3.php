...
foreach($_POST as $value){
	if($value === ""){
		header('Location: form_redirect3.html');
		exit;
	}
}
...
if(isset($_POST['showName'])){
	header("Location: acknowledgement3.php?fname={$_POST['firstName']}&lname={$_POST['lastName']}");
}

else if(isset($_POST['dontShowName'])){
	header("Location: acknowledgement3.php");
}

//acknowledgment3.php?fname={$_POST['firstName']}&lname={$_POST['lastName']}
?>