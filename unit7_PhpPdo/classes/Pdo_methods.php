...
/* THIS CLASS EXTENDS THE DATABASE CONNECTION CLASS AND BUILD ON IT WITH PDO COMMANDS 
    (Makes doing queries in PDO easier.)
    THE DATABASE CONNECTION CLASS CAN BE STORED OUTSIDE OF THE EXAMPLE FILES SO YOU CANNOT SEE 
    THE CONNECTION INFORMATION. ALSO IT IS MORE SECURE*/
    ...
    class PdoMethods extends DatabaseConn {
        ...
        public function selectNotBinded($sql){      //selectNotBinded = doesn't let user enter, it is all hardcoded
                ...
                //THIS CLOSES THE DATABASE CONNECTION
                $this->conn = null; //Important because you will run out of RAM
